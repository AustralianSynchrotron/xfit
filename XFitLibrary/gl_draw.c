/***********************************************************************}
{                                                                       }
{  basic drawing routines : OpenGL version, not threaded                }
{                                                                       }
{  int initialise ()                                                    }
{                                                                       }
...
/* This was the thread function for starting a new thread and 
   opening each window */
...
/* JRH This is the function which executes inside the thread.  We have
   one thread per window.  Data is kept in the OWD structure */
